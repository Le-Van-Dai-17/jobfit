...
export default function JobsError({ unstable_retry }: { error: Error & { digest?: string }; unstable_retry: () => void }) {
  return (
    <div className="rounded-xl border border-border-light bg-surface-white p-5">
      <h2 className="text-lg font-bold text-foreground">Khong the tai feed viec lam</h2>
